...
const submit = () => {
    form.post(route('admin.superviseur.store'));
};
</script>

<template>
    <Head title="Ajouter un Superviseur" />

    <AuthenticatedLayout>
        <template #header>Nouveau Superviseur</template>
        ...
        <div class="max-w-4xl mx-auto pb-20">
            <div class="flex items-center gap-3 mb-8">
                ...
                <div>
                    <h2 class="text-3xl font-black text-gray-900 tracking-tightest">Nouveau Superviseur</h2>
                    <p class="text-sm text-gray-500 mt-0.5">Remplissez les informations complètes du nouvel administrateur.</p>
                </div>
            </div>
