...
const submit = () => {
    form.put(route('supervisor.caissiers.update', props.caissier.id));
};
</script>
        ...
        <div class="max-w-4xl mx-auto pb-20">
            <div class="flex items-center gap-3 mb-8">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500 mt-0.5">Mettez à jour les informations et les parkings du caissier.</p>
                </div>
            </div>
